...
export function platformFeeRate(collectionType: string): number {
  return (
 ...
 */
export function deriveNetContribution(
  grossAmount: number,
  collectionType: string = "fixed",
  feeBearer: FeeBearer = "organizer"
): number {
 ...
 */
export function normalizeContribution<T extends ContributionRow>(
  row: T,
  feeBearer: FeeBearer = "organizer",
  collectionType: string = "fixed"
): T {
 ...
 */
export function normalizeContributions<T extends ContributionRow>(
 ...
 */
export function getSettlementCutoff(now: Date = new Date()): Date {
