...
| | 1.3 | _deferred / awaiting approval_ — build runtime feature flag, shadow/canary validate vs real Supabase, then repoint wizard Edge→Express (Edge kept as fallback) | | |
