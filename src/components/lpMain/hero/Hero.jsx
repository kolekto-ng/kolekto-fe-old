                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
                    ...
                    <div className='order-1 lg:order-1 space-y-8'>
                        ...
                        <div className='inline-flex items-center space-x-5 text-[20px] font-medium'>
                            ...
                            <span className='flex items-center gap-2 bg-green-800 text-white px-3 py-1 rounded-md'><Image height={20} width={20} src={collectionSvg} alt='collection' />Collection</span>
                        </div>
                        ...
                        {logos.map((logo, i) => (
                            <React.Fragment key={i}>
                                ...
                                <div className='marquee-item'>
                                    <Image src={logo.src} alt='Paystack-logo' width={120} height={40} className='h-8 sm:h-10 lg:h-12 w-auto object-contain' />
                                </div>
                                <div className='marquee-item'>
                                    <Image src={logo.src} alt='Paystack-logo' width={120} height={40} className='h-8 sm:h-10 lg:h-12 w-auto object-contain' />
                                </div>
