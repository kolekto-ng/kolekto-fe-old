    ...
    return (
        <section className='flex flex-col gap-7 px-4 py-12 lg:px-8 lg:py-20 max-w-[1280px] w-full mx-auto my-0'>
            <div className='flex md:flex-row justify-between items-center gap-6 flex-col-reverse'>
                <Image height={600} width={600} src={fearuresImage} />
            ...
            <div className='flex gap-1 flex-col md:flex-row justify-between items-center'>
                <div className='flex flex-col gap-1 lg:gap-7'>
                    <Image height={400} width={400} src={cm} alt='collection managementbimage' />
                ...
                <div className='flex flex-col gap-1'>
                    <Image height={400} width={400} src={tired} alt='Tiered Contributions' />
                ...
                <div className='flex flex-col gap-1'>
                    <Image height={400} width={400} src={fundraising} alt='Fundraising' />
                ...
                <div className='flex flex-col gap-1'>
                    <Image height={400} width={400} src={labeling} alt='White-Label Branding' />
