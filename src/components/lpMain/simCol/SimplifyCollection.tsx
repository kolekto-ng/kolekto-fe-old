...
const SimplifyCollection = () => {
    return (
        <section className='py-12 px-4 sm:px-8 flex md:flex-row flex-col-reverse justify-between items-center gap-3 max-w-[1280px] w-full mx-auto my-0'>
            ...
            <img data-aos='fade-up' width={600} height={700} src={simColImage} alt='simplify collection' />
        </section>
    )
}
